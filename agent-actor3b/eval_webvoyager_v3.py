    ...
    if args.selftest:
        ...
        if args.grounding_backend == "gui_actor":
            ...
            if args.use_reflection:
                print(
                    "[eval_webvoyager.py] 주의: --grounding_backend gui_actor는 reflection을 기본적으로 "
            ...
            print(
                f"[eval_webvoyager.py] grounding backend = GUI-Actor ({args.gui_actor_model_id!r}), "
            ...
            print(
                "[eval_webvoyager.py] click grounding = GUI-Actor(coordinate-free pointer) + "
                + (
            ...
            print(
                "[eval_webvoyager.py] 주의: --agent_grounding_adapter_dir 미지정, --grounding_backend gui_actor도 "
